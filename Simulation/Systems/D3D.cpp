...
void D3D::CreateSwapChainAndDevice()
{
	...
	gpuMemorySize = adapterInfos[selected_adapter_index]->AdapterDesc.DedicatedVideoMemory / 1024 / 1024;
	gpuDescription = adapterInfos[selected_adapter_index]->AdapterDesc.Description;

	HRESULT hr = D3D11CreateDeviceAndSwapChain
	(
		adapterInfos[selected_adapter_index]->Adapter
